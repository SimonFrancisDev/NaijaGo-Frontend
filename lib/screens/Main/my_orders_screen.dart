...
//       // print('📡 Pending→Processing update status: ${response.statusCode}'); // Clean up redundant print
//       // print('📄 Response: ${response.body}'); // Clean up redundant print
...
//   Future<void> _fetchUserIdAndOrders() async {
//     // print('🔍 Step 1: Getting SharedPreferences...'); // Clean up redundant print
//     final prefs = await SharedPreferences.getInstance();

//     final userData = prefs.getString('user');
//     // print('📦 Step 2: Retrieved user data: $userData'); // Clean up redundant print

//     if (userData != null) {
//       try {
//         final decodedUser = json.decode(userData);
//         // print('🛠 Step 3: Decoded user JSON: $decodedUser'); // Clean up redundant print

//         final user = User.fromJson(decodedUser);
//         // print('👤 Step 4: User object created: ${user.toJson()}'); // Clean up redundant print
//         // print('🆔 Step 5: User ID found: ${user.id}'); // Clean up redundant print
...
//       // print('📡 Response status code: ${response.statusCode}'); // Clean up redundant print
//       // print('📄 Raw response body: ${response.body}'); // Clean up redundant print
