...
class Order {
  ...
  Order({
    ...
    this.isPaid = false,
    this.paidAt,
    // ⬇️ FIX: Updated default status from 'pending' to 'pending_payment'
  ...
  factory Order.fromJson(Map<String, dynamic> json) {
    ...
    return Order(
      ...
      status: json['mainOrderStatus'] ?? 'pending_payment', // Changed from 'orderStatus' to 'mainOrderStatus'
...
//       isPaid: json['isPaid'] ?? false,
//       paidAt: json['paidAt'] != null ? DateTime.parse(json['paidAt']) : null,
//       // ⬇️ FIX: Updated fallback status from 'pending' to 'pending_payment'
//       status: json['orderStatus'] ?? 'pending_payment',
