...
class _NaijaGoAppState extends State<NaijaGoApp> {
  // This future is still useful for initial checks and data fetching in MainAppNavigator
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<bool>(
      ...
      builder: (context, snapshot) {
        ...
        // We still fetch isLoggedIn status, but we don't use it to choose the screen 
        // until the splash is done. The MainAppNavigator can use this status internally.
        ...
        if (_showSplash) {
          ...
          // 2. MODIFIED: Always show MainAppNavigator (Home Screen) after splash
...
Future<void> main() async {
  ...
  // These lines are not strictly needed here anymore since we always go to home, 
